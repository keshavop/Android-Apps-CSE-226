...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listView.setOnItemLongClickListener { parent, view, position, id ->
            ...
            val id = view.findViewById<TextView>(R.id.idListItem).
            ...
            builder.setPositiveButton("Edit", DialogInterface.OnClickListener { dialog, which ->
                ...
                GlobalScope.launch {
                    database.ContactDAO().
                            update(Contact(id, updatedName, updatedPhone))
                }
                Toast.makeText(this, "Updated $updatedName " + "$updatedPhone", Toast.LENGTH_LONG).show()
            })
        ...
        btn.setOnClickListener {
            ...
            GlobalScope.launch {
                database.ContactDAO().insert(Contact(id.text.toString().toLong(),
                                                        name.text.toString(),
